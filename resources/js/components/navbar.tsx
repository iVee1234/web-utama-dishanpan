...
const profil = [
  { name: 'Visi & Misi', href: '#', icon: BuildingLibraryIcon },
  { name: 'Logo', href: '#', icon: SparklesIcon },
  { name: 'Struktur Organisasi', href: '#', icon: UserGroupIcon },
  { name: 'Profil Pegawai', href: '#', icon: UserCircleIcon },

]
const program =[
    { name: 'Kegiatan', href: '#', icon: RocketLaunchIcon },
    { name: 'Galeri Kegiatan', href: '#', icon: PhotoIcon },
]
// const callsToAction = [
      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            <img
              alt=""
              src="../../images/logo_kota_semarang.png"
